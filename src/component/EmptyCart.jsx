    ...
    <Box>
      ...
      >
        ...
        <Text fontSize={["sm", "lg", "lg"]}>
          ...
          free next-day delivery on Products.
        </Text>
      ...
      <Box borderTop="1px solid gray" borderBottom="1px solid gray">
        <Text p="20px" textAlign={"center"}>
          Need some help? Chat now (Opens in a new window)or call
          1-800-Smart-Mart.
        </Text>
      </Box>
                ...
                <AccordionPanel pb={6} textAlign="start">
                  ...
                  <AccordionItem p={4}>
                    ...
                    <AccordionPanel pb={4}>
                      ...
                      during checkout. Learn more about Shipping & Pickup
                    </AccordionPanel>
                  </AccordionItem>
                  ...
                  <AccordionItem p={4}>
                    <h2>
                      <AccordionButton>
                        <Box as="span" flex="1" textAlign="left">
                          Can I pick up my items at an Store?
                        </Box>
                        <AccordionIcon />
                      </AccordionButton>
                    </h2>
                  ...
                  <AccordionItem p={4}>
                    <h2>
                      <AccordionButton>
                        <Box as="span" flex="1" textAlign="left">
                          How do I learn what my Smart-Mart Store is doing to
                          make shopping and services safer for customers?
                        </Box>
                        <AccordionIcon />
                      </AccordionButton>
                    </h2>
                    ...
                    <AccordionPanel pb={4}>
                      ...
                      information for your local Smart Store via Find a Store
                    </AccordionPanel>
                  </AccordionItem>
                  ...
                  <AccordionItem p={4}>
                    ...
                    <AccordionPanel pb={4}>
                      We accept Pay(opens in a new window), most credit and
                      debit cards, PayPal, and Store Gift Cards — though PayPal,
                      Store Gift Cards, and financing options may not be
                      available for all products. Financing options are also
                      available to qualifying customers. You can call
                      1‑800‑MY‑APPLE for more information. Learn more about
                      Payment & Pricing
                    </AccordionPanel>
                  </AccordionItem>
                  ...
                  <AccordionItem p={4}>
                    ...
                    <AccordionPanel pb={4}>
                      ...
                      based on item availability and the shipping option you
                      choose. For pickup, you’ll choose a pickup date and store
                      during checkout. Learn more about Shipping & PickupThe tax
                      listed on the Bag and Checkout pages is an estimate. Your
                      invoice will reflect the final total tax, which includes
                      state taxes, local taxes, and any applicable fees. Learn
                      more about Payment & Pricing
                    </AccordionPanel>
                  </AccordionItem>
                  ...
                  <AccordionItem p={4}>
                    ...
                    <AccordionPanel pb={4}>
                      Yes. offers special pricing for students, teachers,
                      administrators, staff members, and homeschooling programs.
                      If you think you qualify, visit the Store for
                      Education(opens in a new window) to place your order.
                      Learn more about Payment & Pricing
                    </AccordionPanel>
                  </AccordionItem>
                  ...
                  <AccordionItem p={4}>
                    ...
                    <AccordionPanel pb={4}>
                      ...
                      items when you choose to check out with Card Monthly
                      Installments. And if you’re buying an iPhone, Mac, iPad,
                      or Watch, you can add a trade-in and pay even less.◊◊
                    </AccordionPanel>
                  </AccordionItem>
                  ...
                  <AccordionItem p={4}>
                    <h2>
                      <AccordionButton>
                        <Box as="span" flex="1" textAlign="left">
                          When I buy an iPhone from , will the eSIM be
                          activated?
                        </Box>
                        <AccordionIcon />
                      </AccordionButton>
                  ...
                  <AccordionItem p={4}>
                    ...
                    <AccordionPanel pb={4}>
                      ...
                      based on item availability and the shipping option you
                      choose. For pickup, you’ll choose a pickup date and store
                      during checkout. Learn more about Shipping & PickupThe
                      iPhone models for AT&T, T-Mobile, Sprint, and Verizon are
                      the same. If you choose to pay with an AT&T Installment
                      Plan, your iPhone will be locked to the carrier. For
                      details on network support, please see
